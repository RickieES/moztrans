...
public class CurrentTextColumn implements ComplexColumn
{
    ...
    public void setValue(Phrase currentPhrase, Object value, String currentLocalization)
    {
        ...
        if (!strValue.equals(""))
        {
            currentTranslation = (Translation) currentPhrase.getChildByName(currentLocalization);
            if (currentTranslation == null)
            {
                currentTranslation = new Translation(currentLocalization, currentPhrase, strValue, Translation.STATUS_TRANSLATED);
