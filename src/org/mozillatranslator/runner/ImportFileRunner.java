...
public class ImportFileRunner extends MozTask {
    /** Creates a new instance of ImportFileRunner */
    public ImportFileRunner() {
    }
    ...
    public void taskImplementation() throws MozException {
        try {
            ...
            FileInputStream fis = new FileInputStream(dao.getFileName());
            
            data.setFileName(dao.getFileName());
            data.setFileContent(FileUtils.loadFile(fis));
            fis.close();
            ...
            throw new MozException("Error during file import", e);
        }
    }
