 ...
 * @version 1.00
 */
public class ImportFileAction extends TaskAction {
    /** Creates new AboutAction */
    public ImportFileAction() {
        super(Kernel.translate("menu.import.file.label"),
              new FileTransferDialog(Kernel.translate("Import"),
              ImportExportDataObject.FORMAT_MOZILLA),
              new ImportFileRunner());
    }
}